...
<nav id="navbar">
  ...
  <div id="navbarDiv">
    <div id="navDiv">
      <a href="index.php"><img src="media/logo.jpeg" alt="logo" id="logo" /></a>
    </div>
    <ul id="menu">
      ...
      <li class="<?= isset($_SESSION["autenticado"]) ? 'elementoMenu' : 'test' ?>"><a
          href="#pedirCita"><?= isset($_SESSION["autenticado"]) ? 'Pedir Cita' : '' ?></a></li>
      <li class="<?= isset($_SESSION["autenticado"]) ? 'elementoMenu' : 'test' ?>"><a
          href="includes/agenda.php"><?= isset($_SESSION["autenticado"]) ? 'Agenda' : '' ?></a></li>
      <li class="elementoMenu"><a href="#contacto">Contacto</a></li>
      <li class="elementoMenu"><a href="#blog">Blog</a></li>
      <li class="elementoMenu" id="inicioSesion"><a
          href="includes/login.php"><?= isset($_SESSION["autenticado"]) ? '' : 'Iniciar Sesion' ?></a></li>
      <?php
      if (!isset($_SESSION["autenticado"])):
        ?>
        <button class="elementoBoton">
          <a href="includes/registro.php"><?= isset($_SESSION["autenticado"]) ? '' : 'Unete' ?> &nbsp;&nbsp;</a>
        </button>
        <?php
